...
export const createAdmin = async (req : any, res : Response)=>{
    try {
        ...
        const admin = await adminModel.create({companyName, companyEmail, companyAddress, companyPhoneNo, passWord : hash,
...
export const signInAdmin = async (req : any, res : Response)=>{
    try {
